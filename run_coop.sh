...
# python ./code/main.py -p with environment.config_file=coop.yaml seed=6673
# python ./code/main.py -p with environment.config_file=coop.yaml seed=84145
# python ./code/main.py -p with environment.config_file=coop.yaml seed=9911
# python ./code/main.py -p with environment.config_file=coop.yaml seed=1026