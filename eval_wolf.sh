...
# python ./code/ckpt_main.py -p with environment.config_file=wolf.yaml seed=123 load.run=20 log.test_dir=wolf
# python ./code/ckpt_main.py -p with environment.config_file=wolf.yaml seed=445 load.run=21 log.test_dir=wolf
# python ./code/ckpt_main.py -p with environment.config_file=wolf.yaml seed=7881 load.run=22 log.test_dir=wolf
# python ./code/ckpt_main.py -p with environment.config_file=wolf.yaml seed=1116 load.run=23 log.test_dir=wolf
